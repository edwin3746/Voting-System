...
Wait for the script to finish generating the required parameters and authentications. The output will be as shown in the screenshot below.
...
After keying the PEM pass phrase, let it run and finish the votes accumulation and decryption process and ‘server.py’ will have the following output as shown in the screenshot below.
