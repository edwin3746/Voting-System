    ...
    while not connected:
        try:
            ...
            if msgCode == "Connection is secure":
                ...
                for i in range(3):
                    passwordAttempt = pyautogui.password(text='Enter password for decryption', title='Authenticator 1', default='',
                                                         mask='*')
                    try:
...
def main():
    ...
    userPassword = pyautogui.password(text='Enter password for encryption', title='Authenticator 1', default='', mask='*')
