...
def main():
    ...
    print("Value of Authenticator 1 Commitment : " + str(auth1Commitment))
    print("Value of Authenticator 2 Commitment : " + str(auth2Commitment))
    ...
    print("------- Authenticator's Partial Public Key Values -------")
    print("Value of Authenticator 1 Public Key : " + str(partialPublicKey1))
    print("Value of Authenticator 1 Random R : " + str(auth1R))
    print("Value of Authenticator 2 Public Key : " + str(partialPublicKey2))
    print("Value of Authenticator 2 Random R : " + str(auth2R))
    print("------- End of Authenticator's End of Partial Public Key Values -------")
    ...
    print("------- Server's Partial Public Key Values -------")
    print("Value of Server's partial Public Key : " + str(partialPublicKey3))
    print("Value of Server's partial Private Key : " + str(partialPrivateKey))
    print("------- End of Server's Partial Public Key Values -------")
    ...
    print("Value of Public Key : " + str(publicKey))
    print("------- End of Public Key Values -------")
    ...
    if accumulatedVotes:
        ...
        for key, encryptedVotes in accumulatedVotes.items():
            ...
            bValue = 1
            count = 0
        print("------- Encrypted Ciphertext values -------")
        print("Value of accumulated ciphertext a : " + str(accumulatedEncryptedAValue))
        ...
        print("------- Partially Decrypted a (Server) -------")
        print("Value of partially decrypted a value by server : " + str(partialDecryptedVote))
        print("------- End of Partially Decrypted a (Server) -------")
        a = 0
